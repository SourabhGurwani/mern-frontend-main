...
export default function Order() {
  ...
  useEffect(() => {
    if (user?.email) { fetchOrders(); } else { setLoading(false); }
  }, [user]);
  ...
  return (
    <div className="order-container">
      ...
      {loading && <div className="loading-orders"><p>Loading your orders...</p></div>}
      {!loading && !user?.email && (
        <div className="login-prompt">
          <img src="https://cdn-icons-png.flaticon.com/512/1828/1828466.png" alt="Login required" />
